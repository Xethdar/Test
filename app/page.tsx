...
export default function LandingPage() {
  ...
  return (
    <>
      <div className="flex min-h-[100dvh] flex-col">
        <header className="fixed top-0 left-0 right-0 z-[9999] w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
  ...
  >
    ...
    <div className="flex flex-col items-center md:items-start">
      ...
      <section
  id="contact"
  className="w-full py-12 md:py-24 lg:py-32 bg-muted scroll-mt-24">
  <div className="container px-4 md:px-6">
    <div className="flex flex-col items-center justify-center space-y-4 text-center">
      <div className="space-y-2">
