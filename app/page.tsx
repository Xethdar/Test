                  ...
                  <div className="flex flex-col items-center justify-center space-y-6 py-0">
                    ...
                    <div className="pt-4 space-y-3">
                      <Button asChild variant="outline" size="lg">
                        <Link href="/survey" className="text-sm font-medium hover:text-primary" style={{marginTop: "0rem", border: "white solid 1px", color: "white"}}>Share your ideas and opinions</Link>
                      </Button>
