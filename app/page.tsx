          ...
          <section id="about-us" className="w-full py-12 md:py-22 lg:py-32">
            <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6 text-sm md:text-base text-gray-300">
                ...
                <p>
                  In recent years, bond market investing has become increasingly harder, as the market gets monopolized
                  by a few powerful financial institutions; banks, asset managers, foreign governments, etc. There used
                  to be a time when regular people in places like the United States funded the nation's war efforts via
                  bonds. Now the descendants of the same people who built the greatest country in the world and had its
